...
const shldr = `${import.meta.env.BASE_URL.replace(/\/$/, '')}/shoulder.gif`;
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-400 mt-1">Real-time overhead extension analysis</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="order-2 lg:order-1 bg-gray-800 rounded-xl p-4 shadow-lg">
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-gray-700 rounded-lg p-3 text-center">
                  ...
                  <p className="text-lg sm:text-xl font-bold text-blue-400">Shoulder Press</p>
                </div>
            ...
            <div className="mb-6">
              ...
              <div>
                <img src={shldr} alt="" className='mt-4 rounded-xl max-h-60 object-contain mx-auto'/>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-300">
                ...
                <li>Press weights all the way overhead</li>
                <li>Lower dumbbells to ear level with control</li>
                <li>Maintain a steady pace and neutral spine</li>
              </ul>
            </div>
          </div>
