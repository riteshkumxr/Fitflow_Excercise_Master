      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-400 mt-1">Seated ergonomic arm reactivation tracking</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="order-2 lg:order-1 bg-gray-800 rounded-xl p-4 shadow-lg">
            ...
            <div className="mb-6">
              ...
              <img src={curlsGif} alt="Desk curls demo" className="rounded-xl w-full max-h-60 object-contain mx-auto shadow-md" />
            </div>
            
            <div>
              <h2 className="text-xl font-bold mb-3">Tips for Desk Curls</h2>
              <ul className="list-disc pl-5 space-y-2 text-gray-300">
                <li>Position camera so your upper body and arms are clearly visible</li>
                <li>Sit up tall with shoulders relaxed and back against chair</li>
                <li>Keep elbows stable at your sides</li>
                <li>Curl hands upward smoothly and squeeze biceps</li>
