      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-400 mt-1">Real-time hip drive & knee elevation tracking</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="order-2 lg:order-1 bg-gray-800 rounded-xl p-4 shadow-lg">
            ...
            <div className="mb-6">
              ...
              <img src={highKneesGif} alt="High Knees demo" className="rounded-xl w-full max-h-60 object-contain mx-auto shadow-md" />
            </div>
            
            <div>
              <h2 className="text-xl font-bold mb-3">Tips for High Knees</h2>
              <ul className="list-disc pl-5 space-y-2 text-gray-300">
                <li>Position camera to see your full or lower body</li>
                <li>Stand tall with your chest up</li>
                <li>Drive your knees up toward hip level</li>
                <li>Land softly on the balls of your feet</li>
                <li>Keep a quick, explosive rhythm</li>
              </ul>
            </div>
          </div>
