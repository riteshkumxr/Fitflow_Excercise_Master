    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-10">
      ...
      <div className="flex items-center gap-2 mb-8 overflow-x-auto pb-2">
        {[
          ...
          { id: 'upper', label: 'Upper Body', count: 5, icon: Dumbbell },
          { id: 'lower', label: 'Lower Body', count: 3, icon: Flame },
          { id: 'desk', label: 'Desk & Posture Breaks', count: 3, icon: Laptop },
        ].map((tab) => {
          const Icon = tab.icon;
        ...
        {filteredWorkouts.map((workout) => (
          ...
          >
              ...
              <div className="relative aspect-video bg-slate-900 overflow-hidden flex items-center justify-center">
                {workout.gif ? (
                  ...
                  <div className="flex flex-col items-center justify-center text-slate-500 p-6 text-center">
                    <Laptop size={36} className="text-emerald-400 mb-2" />
                ...
                <div className="absolute top-3 left-3 flex items-center gap-1.5">
                  ...
                  <span className="px-2.5 py-1 rounded-full bg-emerald-500/85 text-white text-[11px] font-bold backdrop-blur-md">
                    {workout.difficulty}
                  </span>
                </div>
            ...
            <div className="p-6 pt-0">
              <Link
                to={workout.path}
                className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-slate-900 hover:bg-emerald-600 dark:bg-slate-800 dark:hover:bg-emerald-600 text-white text-xs font-bold transition-all shadow-sm group-hover:shadow-md"
              >
      ...
      {/* Camera Guidance Box */}
      <div className="rounded-3xl bg-emerald-50/60 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-800/40 p-6 md:p-8">
